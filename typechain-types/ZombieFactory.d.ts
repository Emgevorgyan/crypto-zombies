...
export interface ZombieFactoryContract
  extends Truffle.Contract<ZombieFactoryInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ZombieFactoryInstance>;
}
...
export interface ZombieFactoryInstance extends Truffle.ContractInstance {
  createRandomZombie: {
